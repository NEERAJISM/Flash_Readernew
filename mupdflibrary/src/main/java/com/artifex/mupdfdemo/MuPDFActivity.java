...
public class MuPDFActivity extends Activity {
    ...
    enum AcceptMode {Highlight, Underline, StrikeOut, Ink, CopyText,Dictionary};
    ...
    private RelativeLayout mPageSlider;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (core == null) {
            ...
            if (getIntent().getExtras() != null && getIntent().getExtras().containsKey("FileNameKey")) {
                mFileName = getIntent().getExtras().getString("FileNameKey");
                fileName = getIntent().getExtras().getString("FileName");
                path = getIntent().getExtras().getString("path");
                core = openFile(Uri.decode(mFileName));
            }
        }
        if (core == null) {
    ...
    public void createUI(Bundle savedInstanceState) {
        ...
        mDocView = new MuPDFReaderView(this) {
            ...
            protected void onMoveToChild(int i) {
                ...
                mPageNumberView.setText(String.format("%d / %d", i + 1,
                        core.countPages()));
                mSlider.setMax((core.countPages() - 1) * mPageSliderRes);
                mSlider.setProgress(i * mPageSliderRes);
        ...
        // Activate the search-preparing button
        b_notes_open.setOnLongClickListener(new View.OnLongClickListener(){
            @Override
    ...
    private void showButtons() {
        ...
        if (!mButtonsVisible) {
            ...
            mSlider.setMax((core.countPages() - 1) * mPageSliderRes);
            mSlider.setProgress(index * mPageSliderRes);
            if (mTopBarMode == TopBarMode.Search) {
    ...
    private void makeButtonsView() {
        ...
        mSlider = (SeekBar) mButtonsView.findViewById(R.id.slider);
        mPageSlider = (RelativeLayout) mButtonsView.findViewById(R.id.pageSlider);
        mPageNumberView = (TextView) mButtonsView.findViewById(R.id.pageNumber);
        mInfoView = (TextView) mButtonsView.findViewById(R.id.info);
        mSearchButton = (Button) mButtonsView.findViewById(R.id.searchButton);
        b_notes_open = (Button) mButtonsView.findViewById(R.id.b_notes);
        ...
        mbCopy = (Button) mButtonsView.findViewById(R.id.b_notes);
        mSearchFwd = (Button) mButtonsView.findViewById(R.id.searchForward);
        mSearchText = (EditText) mButtonsView.findViewById(R.id.searchText);
        //mLinkButton = (Button) mButtonsView.findViewById(R.id.linkButton);
        //mMoreButton = (ImageButton) mButtonsView.findViewById(R.id.moreButton);
        viewFlipper = (ViewFlipper) mButtonsView.findViewById(R.id.view_flipper);
        mTopBarSwitcher.setVisibility(View.INVISIBLE);
        mPageNumberView.setVisibility(View.INVISIBLE);
        mInfoView.setVisibility(View.INVISIBLE);
        mPageSlider.setVisibility(View.INVISIBLE);
        //relativeLayout = (RelativeLayout) mButtonsView.findViewById(R.id.longClickPage);
    }
    ...
    public void Dictionary(View v) {
        ...
        mDocView.setMode(MuPDFReaderView.Mode.Selecting);
        mAnnotTypeText.setText("Dictionary");
        showInfo(getString(R.string.select_text));
    }
        ...
        switch (mAcceptMode) {
            case CopyText:
                if (pageView != null)
                {
                    ...
                    mTopBarMode = TopBarMode.More;
                    if(success) {
                        showInfo(getString(R.string.copied_to_clipboard));
                        ...
                        try {
                            Toast.makeText(MuPDFActivity.this, path, Toast.LENGTH_SHORT).show();
                            output = new BufferedWriter(new FileWriter(path + "/" + fileName + "_flash.txt", true));
                            output.append(text);
                            output.close();
                        } catch (Exception e) {
                            e.printStackTrace();
            ...
            case Highlight:
                if (pageView != null)
                {
                    ...
                    try {
                        Toast.makeText(MuPDFActivity.this, path, Toast.LENGTH_SHORT).show();
                        output = new BufferedWriter(new FileWriter(path + "/" + fileName + ".txt", true));
                        output.append(text);
                        output.close();
                    } catch (Exception e) {
                        e.printStackTrace();
            ...
            case Dictionary:
                Intent i = new Intent(MuPDFActivity.this,SearchableDictionary.class);
                myClipboard = (ClipboardManager) getSystemService(CLIPBOARD_SERVICE);
                ClipData abc = myClipboard.getPrimaryClip();
                ClipData.Item item = abc.getItemAt(0);
                String text = item.getText().toString();
